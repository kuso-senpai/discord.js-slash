...
declare module 'discord.js' {
  ...
  export class Client extends BaseClient {
    ...
    public slashCommands: SlashCommandsManager;
  ...
  export class Interaction {
      ...
      member: {
        ...
        roles: Array
        premium_since: Date | String | undefined
        permissions: String
        pending: Boolean
  ...
  export class SlashCommand extends Base {
    // constructor(client: Client, name: String, description: String, options: SlashCommandOption[]);
    constructor(client: Client, name: String, description: String, options?: SlashCommandOption, data?: Object, onCall: Function)
    ...
    public onCall(command: SlashCommand, interaction: Interaction, args?: [{value: String | Number, type: SlashCommandOptionTypes, name: String}], messageData?: {channel: TextChannel, guild: Guild, author: User})
    public reply(content: String, hide?): Promise
    public register(): Promise
    public delete(): Promise
  }

  export class SlashGuildCommand extends SlashCommand {
    constructor(client: Client, guild: Guild | Snowflake, name: String, description: String, options?: SlashCommandOption[], data?: Object)
    public readonly guildID: Snowflake
  }

  export class SlashCommandOption {
    constructor (name: String, description: Srting, type: Number, required: Boolean, choices: [{name: String, value: String | Number}] | undefined)
  ...
  export class SlashCommandsManager extends BaseManager<Snowflake, SlashCommand, SlashCommandResolvable> {
    constructor(client: Client)

    public readonly commandsJSON: JSON[];
    public add(data: Object);
    public remove(id: Snowflake);
    public fetch(id: Snowflake, cache?: boolean, force?: boolean);
    public fetchAll(): Promise;
    public deleteAll(): Promise;
    public create(data: {name: String, description: String, options: SlashCommandOption[]}): Promise<SlashCommand>
  ...
  type SlashCommandResolvable = SlashCommand
